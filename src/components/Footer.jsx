import { FaFacebookF, FaGithub, FaTwitter, FaDribbble, FaDiscord } from 'react-icons/fa';
      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center">
          ...
          <div className="flex mt-4 sm:mt-0">
            <a href="#" className="text-gray-400 hover:text-white mx-2"><FaFacebookF /></a>
            <a href="#" className="text-gray-400 hover:text-white mx-2"><FaGithub /></a>
            <a href="#" className="text-gray-400 hover:text-white mx-2"><FaTwitter /></a>
            <a href="#" className="text-gray-400 hover:text-white mx-2"><FaDiscord /></a>
            <a href="#" className="text-gray-400 hover:text-white mx-2"><FaDribbble /></a>
          </div>
        </div>
      </div>
    </footer>
